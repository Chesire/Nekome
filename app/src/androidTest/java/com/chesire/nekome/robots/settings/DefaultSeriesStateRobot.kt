...
class DefaultSeriesStateResultRobot {
    ...
    fun currentIsSelected() {
        assertChecked(UserSeriesStatus.Current.stringId);
    }
    ...
    fun completedIsSelected() {
        assertChecked(UserSeriesStatus.Completed.stringId);
    }
    ...
    fun onHoldIsSelected() {
        assertChecked(UserSeriesStatus.OnHold.stringId);
    }
    ...
    fun droppedIsSelected() {
        assertChecked(UserSeriesStatus.Dropped.stringId);
    }
    ...
    fun plannedIsSelected() {
        assertChecked(UserSeriesStatus.Planned.stringId);
    }
}
