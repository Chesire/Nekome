...
class FilterOptionsRobot(private val composeContentTestRule: ComposeContentTestRule) {
    ...
    fun clickCurrent() {
        composeContentTestRule
            .onNodeWithText(Resource.string.filter_by_current.getResource())
            .performClick()
    }
    ...
    fun clickCompleted() {
        composeContentTestRule
            .onNodeWithText(Resource.string.filter_by_completed.getResource())
            .performClick()
    }
    ...
    fun clickOnHold() {
        composeContentTestRule
            .onNodeWithText(Resource.string.filter_by_on_hold.getResource())
            .performClick()
    }
    ...
    fun clickDropped() {
        composeContentTestRule
            .onNodeWithText(Resource.string.filter_by_dropped.getResource())
            .performClick()
    }
    ...
    fun clickPlanned() {
        composeContentTestRule
            .onNodeWithText(Resource.string.filter_by_planned.getResource())
            .performClick()
    }
...
class FilterOptionsResultsRobot(private val composeContentTestRule: ComposeContentTestRule) {
    ...
    fun isLoadedCorrectly() {
        ...
        collection[0].assertTextContains(Resource.string.filter_by_current.getResource())
        collection[1].assertTextContains(Resource.string.filter_by_completed.getResource())
        collection[2].assertTextContains(Resource.string.filter_by_on_hold.getResource())
        collection[3].assertTextContains(Resource.string.filter_by_dropped.getResource())
        collection[4].assertTextContains(Resource.string.filter_by_planned.getResource())
    }
